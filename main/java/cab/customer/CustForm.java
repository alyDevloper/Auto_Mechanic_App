...
public class CustForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cust_form);
        ...
        textViewBack.setOnClickListener(v -> {
            Intent FuelElectIntent = new Intent(CustForm.this, CustModule.class);
        ...
        buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (validateForm()) {
                    saveData();
                    Intent intent = new Intent(CustForm.this, CustModule.class);
                ...
                try {
                    ...
                    if (exception.getStatusCode() == LocationSettingsStatusCodes.RESOLUTION_REQUIRED) {
                        ...
                        try {
                            ...
                            resolvable.startResolutionForResult(CustForm.this, LOCATION_REQUEST_CHECK_SETTINGS);
    ...
    private boolean validateForm() {
        ...
        if (name.isEmpty()) {
            Toast.makeText(CustForm.this, "Please enter your name", Toast.LENGTH_SHORT).show();
            return false;
        }

        if (phone.isEmpty()) {
            Toast.makeText(CustForm.this, "Please enter your phone number", Toast.LENGTH_SHORT).show();
            return false;
        }

        if (description.isEmpty()) {
            Toast.makeText(CustForm.this, "Please enter a description", Toast.LENGTH_SHORT).show();
            return false;
        }

        if (address.isEmpty()) {
            Toast.makeText(CustForm.this, "Please enter your address", Toast.LENGTH_SHORT).show();
            return false;
        }

        if (landmark.isEmpty()) {
            Toast.makeText(CustForm.this, "Please set the location", Toast.LENGTH_SHORT).show();
            return false;
        }
